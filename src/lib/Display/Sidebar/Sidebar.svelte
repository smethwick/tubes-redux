...
<aside class="sidebar min-h-full h-full flex flex-col min-w-[18rem] w-[18rem] max-w-[18rem] pt-2">
	{#if provider.has_flag(ProviderFlags.MultipleConnections)}
		<NetworkPicker {nets} />
		<hr class="border border-neutral-300 border-dashed mx-5 mt-2 mb-0.5" />
	{/if}
